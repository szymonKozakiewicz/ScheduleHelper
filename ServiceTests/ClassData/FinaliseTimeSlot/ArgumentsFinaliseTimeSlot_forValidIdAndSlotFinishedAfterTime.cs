...
{
    public class ArgumentsFinaliseTimeSlot_forValidIdAndSlotFinishedAfterTime :IEnumerable<object[]>
    {
        public IEnumerator<object[]> GetEnumerator()
        {
            ...
            var actualFinishTime = new TimeOnly(14, 0);
